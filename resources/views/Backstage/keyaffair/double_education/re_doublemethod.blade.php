...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/Backstage/keyaffair/double_education/re_doublemethod.css') }}">
@endsection
@section('content')
    <div style="border:1px solid #ccc" class="form_container container mb-5">
        @foreach ($re_alltexts as $re_alltext)
            <div class="row">
                <div class="col-12">
                    <h1><b>修改國際雙聯學制檔案</b></h1>
                    <!-- <p>Please fill in this form to create an account.</p> -->
                    <hr>
                    <form action='{{ route('re_doublemethod',['id' => $re_alltext->id]) }}' method='POST' class="col-12">
                        @csrf

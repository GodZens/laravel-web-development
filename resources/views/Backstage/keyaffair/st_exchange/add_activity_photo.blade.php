...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/Backstage/keyaffair/st_exchange/add_activity_photo.css') }}">
@endsection
@section('content')
    <div style="border:1px solid #ccc" class="form_container container mb-5">
        <div class="row">
            <div class="col-12">
                <h1>新增活動照片</h1>
                <hr>
                <form action='{{ route('add_activity_photo') }}' method="POST" enctype="multipart/form-data">
                    @csrf
                    <label for="title" class="d-block mt-3"><b>標題</b></label>
                    <input type="text" name="title" required>

                    <label for="descrition" class="mt-2 d-block">圖片說明</label>
                    <textarea cols="35" rows="10" name="descrition" rosw="200" required></textarea>

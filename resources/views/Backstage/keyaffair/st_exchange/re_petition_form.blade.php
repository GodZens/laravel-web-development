...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/Backstage/keyaffair/st_exchange/re_petition_form.css') }}">
@endsection
@section('content')
        ...
        @foreach ($re_alltexts as $re_alltext)
            <div class="row">
                <div class="col-12">
                    ...
                    <hr>
                    <form action='{{ route('re_petition_form',['id' => $re_alltext->id]) }}' method='POST' class="col-12">
                        @csrf
                        ...
                        <div class="clearfix">
                            ...
                            <a href="{{ route('petition_form') }}"><button type="button" class="cancelbtn">返回</button></a>
                        </div>
                    </form>
                </div>
            </div>

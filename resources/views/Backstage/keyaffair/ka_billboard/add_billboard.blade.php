...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/Backstage/keyaffair/ka_billboard/add_billboard.css') }}">
@endsection
@section('content')
    <div style="border:1px solid #ccc" class="form_container container mb-5">
        <div class="row">
            <div class="col-12">
                ...
                <hr>
                <form action='{{ route('add_billboard') }}' method="POST">
                    @csrf

                    <span class="mr-3"><b>新增學年度</b></span>
                    <select name="year">
                    ...
                    <input type="text" name="Performance_eng">

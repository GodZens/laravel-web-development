...
@section('stylesheets')
    <link rel="stylesheet" type="text/css"
        href="{{ asset('css/Backstage/curriculum/re_secondforeign.css') }}">
@endsection
@section('content')
        ...
        @foreach ($secondforeigns as $secondforeign)
            <div class="row">
                <div class="col-12">
                    ...
                    <hr>
                    <form action='{{ route('re_secondforeign',['id' => $secondforeign->id]) }}' method='POST' class="col-12">
                        @csrf

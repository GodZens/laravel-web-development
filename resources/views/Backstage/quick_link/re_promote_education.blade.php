...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/Backstage/quick_link/re_promote_education.css') }}">
@endsection
@section('content')
        ...
        @foreach ($re_alltexts as $re_alltext)
            <div class="row">
                <div class="col-12">
                    ...
                    <hr>
                    <form action='{{ route('re_promote_education',['id' => $re_alltext->id]) }}' method='POST' class="col-12">
                        @csrf
                        ...
                        <div class="clearfix">
                            ...
                            <a href="{{ route('promote_education') }}"><button type="button" class="cancelbtn">返回</button></a>
                        </div>
                    </form>
                </div>
            </div>

...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/Backstage/quick_link/delete_booktype.css') }}">
@endsection
@section('content')
    <div style="border:1px solid #ccc" class="form_container container mb-5">
        <div class="row">
            <div class="col-12">
                ...
                <form action='{{ route('delete_booktype') }}' method="POST">
                    @csrf
                    <div class="col-12 m-auto ">
                        ...
                        <select name="type">
                            ...
                            @foreach ($librarytypes as $librarytype)
                                <option value="{{ $librarytype->id }}">{{ $librarytype->type }}
                                </option>
                            @endforeach
                        </select>

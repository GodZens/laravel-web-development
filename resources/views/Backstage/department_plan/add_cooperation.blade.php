...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/Backstage/department_plan/add_cooperation.css') }}">
@endsection
@section('content')
    <div style="border:1px solid #ccc" class="form_container container mb-5">
        <form action="{{ route('add_cooperation') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <h1>新增業界合作計畫</h1>
                    ...
                    <input type="text" name="plan-ch" required>

                    <label for="plan-eng"><b>計劃名稱(英文) </b></label>
                    <input type="text" name="plan-eng" required>

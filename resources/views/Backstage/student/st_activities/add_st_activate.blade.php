...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/Backstage/student/st_activities/add_st_activate.css') }}">
@endsection
@section('content')
    <div style="border:1px solid #ccc" class="form_container container mb-5">
        <form action="{{ route('add_st_activate') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-12">
                    <h1>新增學生活動</h1>
                    ...
                    <input name="date" id="date" maxlength="12" type="date" name="event-date">

                    <label for="event-location-ch" class="d-block"><b>活動地點(中文)</b></label>
                    <input type="text" name="event-location-ch" required>

                    <label for="event-location-eng" class="d-block"><b>活動地點(英文)</b></label>
                    <input type="text" name="event-location-eng" required>

                    <label for="event-name-ch" class="d-block"><b>活動名稱(中文)</b></label>
                    <input type="text" name="event-name-ch" required>

                    <label for="event-name-eng" class="d-block"><b>活動名稱(英文)</b></label>
                    <input type="text" name="event-name-eng" required>
                    ...
                    <div class="clearfix">
                        ...
                        <a href="{{ route('student_activate_view') }}"><button type="button" class="cancelbtn">返回</button></a>
                    </div>
                </div>
            </div>
        </form>

...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/Backstage/student/st_thesis/re_related_form.css') }}">
@endsection
@section('content')
    <div style="border:1px solid #ccc" class="form_container container mb-5">
        @foreach ($re_relateds as $re_related)
            <form action="{{route('re_related_form',['id' => $re_related->id])}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <h1>新增相關辦法檔案</h1>
                        ...
                        <input type="text" name="description" value={{ $re_related->description }} required>

                        <label for="file-description-eng"><b>檔案描述(英文)</b></label>
                        <input type="text" name="edescription" value={{ $re_related->edescription }} required>

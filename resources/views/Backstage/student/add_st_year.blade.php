...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/Backstage/student/add_st_year.css') }}">
@endsection
@section('content')
    <div style="border:1px solid #ccc" class="form_container container mb-5">
        <div class="row">
            <div class="col-12">
                ...
                <hr>
                <form action="{{ route('add_st_year') }}" method="POST" class="col-12">
                    @csrf
                    ...
                    <div class="clearfix  mt-3 col-12  d-flex justify-content-center">

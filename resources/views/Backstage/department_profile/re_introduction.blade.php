...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/Backstage/department_profile/re_introduction.css') }}">
@endsection
@section('content')
        ...
        @foreach ($re_alltexts as $re_alltext)
            <div class="row">
                <div class="col-12">
                    ...
                    <hr>
                    <form action='{{ route('re_introduction',['id' => $re_alltext->id]) }}' method='POST' class="col-12">
                        @csrf
                        ...
                        <div class="clearfix">
                            ...
                            <a href="{{ route('introduction') }}"><button type="button" class="cancelbtn">返回</button></a>
                        </div>
                    </form>
                </div>
            </div>

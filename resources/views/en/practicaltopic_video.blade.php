...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/practicaltopic_video.css') }}">
@endsection
@section('content')
    <div class="container ">
        <div class="row justify-content-between">
            ...
            <div class="col-12 col-lg-10 ">
                <div class="col-12 d-flex justify-content-between ">
                    <span>
                        <h1 class="fs-18 color-red mt-5 download-title height-25 "><b class="download-disc">
                            Practical thematic results (results video)</b></h1>
                    </span>
                    <ul class="d-flex ">
                ...
                <div class="col-12 mt-2">
                    <form action='{{ route('en_practicaltopic_video') }}' method='POST'>
                        @csrf
                        <select name="year" onchange="location.href='en_practicaltopic_video?year='+this.value">

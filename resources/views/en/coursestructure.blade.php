            ...
            <div class="col-12 col-lg-10 ">
                <div class="col-12 d-flex justify-content-between ">
                    ...
                    <ul class="d-flex ">
                        ...
                        <li>Course Structure Diagram</li>
                    </ul>
                </div>
                <div class="col-12 mt-2">
                    <form action='{{ route('en_coursestructure') }}' method='POST'>
                        @csrf
                        <select name = "year" onchange="location.href='en_coursestructure?year='+this.value">

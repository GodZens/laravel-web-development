...
<div class="container ">
    <div class="row justify-content-between">
        ...
        <div class="col-12 col-lg-10 ">
            ...
            <div class="col-12">
                <form action='{{ route('en_thesis') }}' method='POST'>
                    @csrf
                    <select name = "year" onchange="location.href='en_thesis?year='+this.value">
            ...
            <div class="col-12 mt-3">
                <table class=" shared_table  table-border table">
                    ...
                    <tbody>
                        <tr>
                            <th style="width:20%" scope="row">{{$thesis->eauthor}}</th>
                            <td style="width:60%" >{{$thesis->etopic}}</td>
                            <td style="width:20%" >{{$thesis->eteacher}}</td>
                        </tr>
                    </tbody>
                    @endforeach
                </table>

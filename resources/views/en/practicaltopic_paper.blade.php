...
@section('stylesheets')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/practicaltopic_paper.css') }}">
@endsection
@section('content')
    <div class="container ">
                ...
                <div class="col-12 d-flex justify-content-between ">
                    <span>
                        <h1 class="fs-18 color-red mt-5 download-title height-25 "><b class="download-disc">
                            Practical Special Topic Results (Thematic group)</b></h1>
                    </span>
                    <ul class="d-flex ">
                        ...
                        <li> Practical Special Topic Results</li>
                    </ul>
                </div>
                <div class="col-12 mt-2">
                    <form action='{{ route('en_practicaltopic_paper') }}' method='POST'>
                        @csrf
                        <select name="year" onchange="location.href='en_practicaltopic_paper?year='+this.value">

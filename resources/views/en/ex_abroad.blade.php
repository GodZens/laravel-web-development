            ...
            <div class="col-12 col-lg-10 ">
                <div class="col-12 d-flex justify-content-between ">
                    ...
                    <ul class="d-flex ">
                        ...
                        <span>></span>
                        <li>Exchange abroad</li>

                    </ul>
                </div>
                <div class="col-12 mt-3">
                    <form action='{{ route('en_ex_abroad') }}' method='POST'>
                        @csrf
                        <select name="year" onchange="location.href='en_ex_abroad?year='+this.value">

                    ...
                    @foreach ($F_teachers as $F_teacher)
                        <div class="col-lg-5 col-12 content-space">
                            <div class="d-flex justify-content-center">
                                <a href="{{route('teacher_content',['name' => $F_teacher->name])}}">
                        ...
                        <div class="col-lg-7 col-12 teacher-pic d-flex flex-wrap mb-2">
                            <div class="col-12 d-flex ">
                                <div class="col-8 p-0">
                                    <span class="d-block">{{$F_teacher->name}}</span>
                                    <span class="d-block">{{$F_teacher->position}}</span>
                                </div>
                            </div>
                            <div class="col-12">
                                <span>{{$F_teacher->education}}</span><br>
                                <span>{{$F_teacher->position}}</span><br>
                                <span>E-mail：<a href="mailto:{{$F_teacher->email}}">{{$F_teacher->email}}</a></span><br>
                                <span>電話分機：{{$F_teacher->extension}}</span><br>
                                <span>實驗室：{{$F_teacher->Researchroom}}</span>
                            </div>
                        </div>
